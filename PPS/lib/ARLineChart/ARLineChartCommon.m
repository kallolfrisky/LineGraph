...
+ (void)drawPoint:(CGContextRef)context point:(CGPoint)point withRadius:(CGFloat)radius color:(UIColor *)color{
    ...
    CGContextAddArc(context, point.x, point.y, radius, 0, 360, 0);
...
+ (void)drawRectangle:(CGContextRef)context withRect:(CGRect)rect withColor:(UIColor *)fillColor
{
    ...
    CGContextSetRGBFillColor(context, 0.0, 0.0, 0.0, 0.6);   //this is the transparent color
...
+(void)drawTriangle:(CGContextRef)context withRect:(CGRect)rect withColor:(UIColor *)fillColor
{
    ...
    CGContextMoveToPoint   (context, CGRectGetMidX(rect), CGRectGetMinY(rect));  // top
    CGContextAddLineToPoint(context, CGRectGetMinX(rect), CGRectGetMaxY(rect));  // left
    CGContextAddLineToPoint(context, CGRectGetMaxX(rect), CGRectGetMaxY(rect));  // right
    CGContextClosePath(context);
